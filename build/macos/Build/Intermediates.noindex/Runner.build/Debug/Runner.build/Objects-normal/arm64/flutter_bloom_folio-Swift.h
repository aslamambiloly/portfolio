...
#ifndef FLUTTER_BLOOM_FOLIO_SWIFT_H
#define FLUTTER_BLOOM_FOLIO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_bloom_folio",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC19flutter_bloom_folio11AppDelegate")
...
SWIFT_CLASS("_TtC19flutter_bloom_folio17MainFlutterWindow")
